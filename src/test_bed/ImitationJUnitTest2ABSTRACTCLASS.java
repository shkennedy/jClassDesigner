 ...
 * @author Shane
 */
public class ImitationJUnitTest2ABSTRACTCLASS extends Application {
    ...
    public void start(Stage fakeStage) {
        ...
        // ThreadExample 0
        ContainerPane container = new ContainerPane(ABSTRACT_CLASS, 500, 50, 20, 20);
        ...
        // 1
        preLoadStrings.add(ContainerType.getString(containers.get(0).getContainer().getType()));
        postLoadStrings.add(ContainerType.getString(dataManager.getContainer(0).getContainer().getType()));
