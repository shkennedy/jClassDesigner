 ...
 * @author Shane
 */
public class ImitationJUnitTest1 extends Application {
    ...
    public void start(Stage fakeStage) {
        ...
        // 1
        preLoadStrings.add(containers.get(1).getContainer().getPackage());
        postLoadStrings.add(dataManager.getContainer(1).getContainer().getPackage());
